...
async def assess_anchorage(vault: Vault, client: RateLimitedClient,
    ...
    steps = forecast_to_steps(forecast_hours)
    ...
    return {"anchorages": ranked, "forecast_hours": len(steps)}
